...
/* HTTP Status Code: códigos (números de tres digitos) uqe trazem info a respeito de como foi sua requisição, se deu tudo certo, aocnteceu algo etc
...
/*
    ...
    o conjunto do metodo http eo recurso (url) é oq da a rota
    ex:
    get /users = buscando um usuario no backd=end
